...
- **Still recorded against Swift 6.3.1 / Xcode 26.4.1**, not re-run: `mvvmc-view/references/architecture.md`'s `@Bindable` `$`-placement note. A compile-behaviour claim, cheaper to check than the SwiftUI measurements.
